...
SCOPE_GROUPS = {
    # GA4 scopes
    "ga4_read": GOOGLE_ANALYTICS_READONLY_SCOPE,
...
def require_multiple_services(service_configs: List[Dict[str, Any]]):
    ...
    Usage:
        @require_multiple_services([
            ...
            {"service_type": "ga4", "scopes": "ga4_read", "param_name": "ga4_service"},
            {"service_type": "ga4_admin", "scopes": "ga4_admin_read", "param_name": "ga4_admin_service"}
        ])
